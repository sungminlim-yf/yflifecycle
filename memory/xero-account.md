...
- **Xero HTTP 노드 `Xero-tenant-id: 7888f054-c786-4c65-809e-4d5db2c01d4c` 헤더 — 전 워크플로우 추가 완료 (2026-05-30)**: #7b(Create Contact), #2(Create/Email Invoice), #2.5(Create/Email Invoice), #3(Fetch Xero Invoice·Fetch AR Invoices), #3-poll(Fetch Modified Invoices). 새 Xero 노드 만들 때 항상 이 헤더 포함할 것.
